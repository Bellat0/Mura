...
class MaqalsCell: UITableViewCell {
...
extension MaqalsCell: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension MaqalsCell: UICollectionViewDelegateFlowLayout {
