...
let aboutUsText = "Mūra - незаменимый помощник для всех, кто стремится расширить свой кругозор и глубже погрузиться в наследие казахской культуры и традиций"

let supportText = "Привет! Мне приятно видеть, что вы пользуетесь приложением Mūra, и я надеюсь, что оно приносит вам пользу. \n\nКак вы могли заметить, Mūra - это абсолютно бесплатное приложение. Однако, чтобы способствовать его дальнейшему развитию, я хотел бы попросить вас о поддержке небольшим донатом. \n\nНиже находится кнопка для копирования номера моей карты в Каспи. Заранее огромное спасибо за вашу поддержку!"
